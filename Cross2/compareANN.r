...
sizes = c(36,71,107,70,28,94,55)

input_columns1 = feature_columns(
...
input_columns2 = feature_columns(
    tf$feature_column$numeric_column("X1"),
    tf$feature_column$numeric_column("X2"),
    tf$feature_column$numeric_column("X3"),
    tf$feature_column$numeric_column("X4"),
...
input_columns3 = feature_columns(
    tf$feature_column$numeric_column("X1"),
    tf$feature_column$numeric_column("X2"),
    tf$feature_column$numeric_column("X3"),
    tf$feature_column$numeric_column("X4"),
    ...
    tf$feature_column$numeric_column("X137"),
    tf$feature_column$numeric_column("X138"),
    tf$feature_column$numeric_column("X139"),
    tf$feature_column$numeric_column("X140"),
    tf$feature_column$numeric_column("X141"),
    tf$feature_column$numeric_column("X142"),
    tf$feature_column$numeric_column("X143"),
    tf$feature_column$numeric_column("X144"),
    tf$feature_column$numeric_column("X145"),
    tf$feature_column$numeric_column("X146"),
    tf$feature_column$numeric_column("X147"),
    tf$feature_column$numeric_column("X148"),
    tf$feature_column$numeric_column("X149"),
    tf$feature_column$numeric_column("X150"),
    tf$feature_column$numeric_column("X151"),
    tf$feature_column$numeric_column("X152"),
    tf$feature_column$numeric_column("X153"),
    tf$feature_column$numeric_column("X154"),
    tf$feature_column$numeric_column("X155"),
    tf$feature_column$numeric_column("X156"),
    tf$feature_column$numeric_column("X157"),
    tf$feature_column$numeric_column("X158"),
    tf$feature_column$numeric_column("X159"),
    tf$feature_column$numeric_column("X160")
)

input_columns4 = feature_columns(
    tf$feature_column$numeric_column("X1"),
    tf$feature_column$numeric_column("X2"),
    tf$feature_column$numeric_column("X3"),
    tf$feature_column$numeric_column("X4"),
...
input_columns5 = feature_columns(
    tf$feature_column$numeric_column("X1"),
    tf$feature_column$numeric_column("X2"),
    tf$feature_column$numeric_column("X3"),
    tf$feature_column$numeric_column("X4"),
...
input_columns6 = feature_columns(
    tf$feature_column$numeric_column("X1"),
    tf$feature_column$numeric_column("X2"),
    tf$feature_column$numeric_column("X3"),
    tf$feature_column$numeric_column("X4"),
...
input_columns7 = feature_columns(
    tf$feature_column$numeric_column("X1"),
    tf$feature_column$numeric_column("X2"),
    tf$feature_column$numeric_column("X3"),
    tf$feature_column$numeric_column("X4"),
...
features = list(input_columns1, input_columns2, input_columns3, input_columns4, input_columns5, input_columns6, input_columns7)


for(list in 1:7)
{

    load(paste("/storage/home/jlp592/work/RevisedUkraine/CrossValidation2/", list, "/tables.RData", sep = ""))

    input_columns = features[[list]]
    nnodes = sizes[list]
        
    fit = dnn_regressor(c(nnodes), feature_columns = input_columns, model_dir = paste("/storage/home/jlp592/work/RevisedUkraine/CrossValidation2/", list, "/theta1/", sep = ""), label_dimension = 1L, weight_column = NULL, optimizer = "Adagrad", activation_fn = "relu", dropout = .3, input_layer_partitioner = NULL, config = NULL)

    X = scale(table1)[train$test,]
    Y = table2[train$test,]

    colnames(X) = paste("X", 1:dim(table1)[2], sep = "")
    colnames(Y) = paste("Y", 1:dim(table2)[2], sep = "")
    ...
    png(filename=paste("/storage/home/jlp592/work/RevisedUkraine/CrossValidation2/", list, "/theta1/test.png", sep = ""))
    plot(hexbin(prediction,data$Y2 - prediction))
    dev.off()
    
    png(filename=paste("/storage/home/jlp592/work/RevisedUkraine/CrossValidation2/", list, "/theta1/test2.png", sep = ""))
    plot(hexbin(prediction,data$Y2))
    dev.off()

    linefit = lm(data$Y2 ~ prediction )
    summary(linefit)
   
    X = scale(table1)[train$model,]
    Y = table2[train$model,]
    ...
    png(filename=paste("/storage/home/jlp592/work/RevisedUkraine/CrossValidation2/", list, "/theta1/train.png", sep = ""))
    plot(hexbin(prediction,data$Y2 - prediction))
    dev.off()

    png(filename=paste("/storage/home/jlp592/work/RevisedUkraine/CrossValidation2/", list, "/theta1/train2.png", sep = ""))
    plot(hexbin(prediction,data$Y2))
    dev.off()
