...
for(n in 1:length)
{
    ...
    {       
        ...
        phat.logit2 = p.logit2 + chain$theta[n] + chain$delta[n,] + chain$gamma[n,list] + rnorm(27, mean = 0, sd = sqrt(chain$sigmaESq[n]/500) )
    ...
    phat.logit.newlist2 = p.logit.newlist2 + chain$theta[n] + chain$delta[n,] + gamma + rnorm(27, mean = 0, sd = sqrt(chain$sigmaESq[n]/500))
