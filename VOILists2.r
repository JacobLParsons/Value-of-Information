...
for(list in 1:7)
{
    ...
    load(file = paste("/storage/home/jlp592/work/RevisedUkraine/CrossValidation2/", list, "/tables2.RData", sep = ""), envir = temp )
...
save(list = c("EVSI", "RVSI", "EVOIR"), file = "VOILists2.RData")
