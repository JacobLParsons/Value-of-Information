...
size = c(100,100,100,100,107,100,100,100,100,100,100,100,100,100,100,100)

test.loss = array(NaN, dim = c(8, 11, 4))
test.loss2 = array(NaN, dim = c(8, 11, 4))
regressionCoef = array(NaN, dim = c(8, 11, 4))
...
for(list in 1:8)
{
    ...
    if(list == 8)
    {
        load(file = paste("/storage/home/jlp592/work/RevisedUkraine/CrossValidation2/", "NSU", "/tables.RData", sep = "") )
    }
